...
::: {.content-visible when-format="revealjs"}   
   정답: b) R, 파이썬, 줄리아, 자바스크립트
   설명: 쿼토는 R, 파이썬, 줄리아, 자바스크립트 등 다양한 프로그래밍 언어를 지원합니다.
:::   
...
::: {.content-visible when-format="revealjs"}   
   정답: c) 중세 유럽의 책 인쇄 방식
   설명: 쿼토는 중세 유럽의 책 인쇄 방식에서 이름을 가져왔습니다. 이는 전지에 8페이지 텍스트를 인쇄하여 한 면에 4페이지씩, 두 번 접어 네 장의 쪽을 만드는 책이나 팸플릿 형식을 의미합니다.
:::   
...
::: {.content-visible when-format="revealjs"}   
   정답: c) 문서의 메타데이터 설정
   설명: YAML은 쿼토에서 문서의 메타데이터를 설정하는 데 사용됩니다. 이는 문서 제목, 작성자, 날짜, 문서 형식 등을 포함합니다.
...
::: {.content-visible when-format="revealjs"}
   정답 및 설명: 싱글 소싱 출판은 콘텐츠 저작부터 디자인, 협업, 검수, 최종 출판물 관리까지 일원화하고 자동화하는 방법입니다. 이는 중복 작업과 낭비를 줄이고 재현 가능성을 높이며, 다양한 형태의 출판저작물을 정확하고 신속하게 제작하는 데에 기여합니다.
:::   

2. 쿼토를 사용하는 주된 이유와 그것이 문서 저작에 어떤 영향을 미치는지 설명해주세요.

::: {.content-visible when-format="revealjs"}
   정답 및 설명: 쿼토는 다양한 프로그래밍 언어를 지원하고, 복잡한 코드 작성 없이도 직관적으로 문서를 작성할 수 있게 해줍니다. 이는 데이터 과학 프로그래밍과 과학기술 문서 작성을 효율적이고 일관된 방식으로 저작하고 출판할 수 있도록 지원합니다.
