...
::: {.content-visible when-format="revealjs"}   
   정답: d) 모두 다
   설명: 웹사이트와 블로그 출판은 인쇄와 배포 비용을 절감하고, 물리적 공간을 절약하며, 실시간 사용자 피드백을 가능하게 합니다.
:::   
...
::: {.content-visible when-format="revealjs"}   
   정답: d) 모두 다
   설명: 쿼토 웹사이트 프로젝트 생성 시 `_quarto.yml`, `index.html`, `style.css` 파일을 포함한 다양한 파일들이 중요합니다.
:::   
...
::: {.content-visible when-format="revealjs"}   
   정답: d) 모두 다
   설명: 웹사이트에는 부츠트랩 기반, 사용자 정의, 미리 정의된 테마 등 다양한 유형의 테마를 적용할 수 있습니다.
:::
...
::: {.content-visible when-format="revealjs"}
   정답 및 설명: 웹사이트와 블로그에서 글꼴과 색상은 중요한 역할을 합니다. 이들은 웹사이트의 전체적인 느낌과 가독성에 영향을 미치며, 브랜드 정체성과 사용자 경험을 향상시키는 데 기여합니다.
:::   

2. 웹사이트와 블로그의 컨텐츠 관리 시스템(CMS)의 역할은 무엇인가요?

::: {.content-visible when-format="revealjs"}
   정답 및 설명: CMS는 웹사이트와 블로그의 컨텐츠를 관리하고 조직하는 데 필수적입니다. 사용자가 쉽게 컨텐츠를 추가, 편집, 삭제할 수 있게 하며, 다양한 미디어와 포스트 형식을 지원하여 효과적인 콘텐츠 전달을 가능하게 합니다.
:::
