...
도서 집필이 마무리된 후 디지털 출판 과정이 이어진다. 
쿼토 책(book)이 영문 도서출판에 초점이 맞춰져 있어 
한국 R 사용자회가 개발한 [bitPublish](https://github.com/bit2r/bitPublish)
...
한국 R 사용자회는 쿼토로 "챗GPT 유닉스 쉘"을 2023년 7월 출판함으로써 가능성을 확인했고 이어서 축적된 경험을 바탕으로 두번째 "챗GPT SQL" 책을 2024년 2월 출판했다. 
